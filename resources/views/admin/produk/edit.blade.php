        ...
        <div class="flex flex-wrap -mx-3 w-2/3">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full bg-white">
                <table class="w-1/4 text-sm text-left text-gray-500 dark:text-gray-400 mx-4 my-2">
                    <div class="">
                        <form method="POST" action="{{ route('admin.produks.update', $produk) }}"
                            ...
                            <div>
                                <div class="flex justify-center">
                                    <div class="relative z-0 w-full mx-6 my-6 group">
                                        <input type="text" name="nama" id="nama"
                                            ...
                                            placeholder=" " required value="{{ $produk->nama }}" />
                                        <label for="nama"
                                ...
                                <div class="flex justify-center">
                                    <div class="relative z-0 w-full mx-6 my-6 group">
                                        ...
                                        <select id="kategori" name="kategori"
                                            ...
                                            <option selected value="{{ $produk->kategori }}">{{ $produk->kategori }}
                                            </option>
                                            <option value="Hasil Olahan Sampah">Hasil Olahan Sampah</option>
                                ...
                                <div class="flex justify-center">
                                    <div class="relative z-0 w-full mx-6 my-6 group">
                                        <div class="w-32">
                                            <img src="{{ Vite::asset('public/assets/img/' . $produk->gambar) }}"
                                                alt="">
                                        </div>
                                        <label
                                ...
                                <div class="flex justify-center">
                                    <div class="relative z-0 w-full mx-6 my-6 group">
                                        <input type="text" name="harga" id="harga"
                                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                            placeholder=" " required value="{{ $produk->harga }}" />
                                        <label for="harga"
                                ...
                                <div class="flex justify-center mb-4">
                                    <div class="relative z-0 w-full mx-6 my-6 group">
                                        <input type="text" name="stok" id="stok"
                                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                            placeholder=" " required value="{{ $produk->stok }}" />
                                        <label for="stok"
                                ...
                                <div class="flex justify-center">
                                    <div class="relative z-0 w-full mx-6 my-6 group">
                                        <textarea name="deskripsi" id="deskripsi"
                                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                            placeholder=" " required rows="4" value="{{ $produk->deskripsi }}"> </textarea>
                                        <label for="deskripsi"
