...
<body class="bg-gray-100">
    ...
    <h1 class="w-1/2 mt-6 ml-20 font-semibold text-2xl">
        New Order
    </h1>
        ...
        <div class="mt-4 border-1 shadow-xl block bg-white w-3/6 ml-16">
            ...
            <fieldset class="pb-8 border-b-2">
                ...
                <div x-data x-init="flatpickr($refs.datetimewidget, { wrap: true, enableTime: true, dateFormat: 'M j, Y h:i K' });" x-ref="datetimewidget"
                    class="relative z-0 w-full mb-6 group ml-12 mt-12">
            ...
            <div class="">
                <fieldset class="pt-8 border-b-2 pb-8 ">
                    ...
                    <div class="space-y-6 ml-12 mr-12 ">
                        <h4 class="leading-6 text-gray-900 font-medium text-sm mb-8 ">Pilih Jenis Sampah <span
                                class="font-light block text-gray-500">(minimal 5 kg)
                            </span>
                        </h4>


                        <div class="grid gap-x-3 border-2 p-4 border-[#A8DFF1] rounded-lg">
                            <div class=" relative flex gap-x-3">
                                ...
                                <div class="text-sm leading-6">
                                    <label for="botol" class="font-medium text-blue-900">Botol Plastik</label>
                                </div>
                            </div>
