                            ...
                            <div class="flex -mx-3">
                                ...
                                <div class="px-3 my-auto">
                                    <h5
                                        ...
                                        Jese Leos</h5>
                                    <p class="mb-6 font-bold dark:text-white capitalize">Software engineer</p>
                                    <x-primary-button
                                    ...
                                    <div class="container mx-auto">
                                        <form class="my-6 w-11/12 mx-auto xl:w-full xl:mx-0">
                                            <div class="xl:w-1/2 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                                <label for="FirstName"
                                                    class="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100">First
                                                    Name</label>
                                ...
                                <div class="mx-auto mt-[20px] pt-4 ml-6 bg-white w-full">
                                    ...
                                    <div class="xl:w-1/2 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                        ...
                                        <div class="flex justify-end">
                                            <x-primary-button
                                                class="bg-sky-600 hover:bg-sky-200 hover:text-sky-600 mt-12">
                                                {{ __('Save All') }}
                                            </x-primary-button>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-white grid grid-cols-2">
                                        ...
                                        <form class="my-6 w-11/12 mx-auto xl:w-full xl:mx-0">
                                            <div class="xl:w-1/2 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                                <label for="FirstName"
                                                    ...
                                                    Password</label>
                                                <input tabindex="0" type="text" id="currentPass" name="currentPass"
                                                    required
                                                    class="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-600 dark:text-gray-400"
                                                    placeholder="••••••••" />
                                            </div>
                                            <div class="xl:w-1/2 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                                <label for="confirmPass"
                                                    ...
                                                    Password</label>
                                                <input tabindex="0" type="text" id="confirmPass" name="confirmPass"
                                                    required
                                                    class="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-600 dark:text-gray-400"
                                                    placeholder="••••••••" />
                                            </div>
                                ...
                                <div class="mx-auto mt-[20px] pt-4 ml-6 bg-white w-full">
                                    ...
                                    <div class="xl:w-1/2 lg:w-1/2 md:w-1/2 flex flex-col mb-4 ml-3">
                                        <p class="text-xs pt-1 text-red-600">Your password must be at least 8 characters or
                                            longer.</p>
                                    </div>
                                    <div class="flex justify-center">
                                        <x-primary-button
